    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Calendar
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a class="btn btn-flex btn-primary" href="<?=base_url()?>staff/addtask">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form fv-plugins-bootstrap5 fv-plugins-framework"
                            action="<?php echo base_url(); ?>Staff/addcalender_task" method="POST"
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-9 fv-plugins-icon-container">
                                            ...
                                            <input class="form-control form-control-solid flatpickr-input"
                                                ...
                                                id="kt_calendar_datepicker_start_date" type="text" readonly="readonly">
                                            <!--end::Input-->
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col" data-kt-calendar="datepicker">
                                        <div class="fv-row mb-9">
                                            ...
                                            <input class="form-control form-control-solid flatpickr-input"
                                                ...
                                                id="kt_calendar_datepicker_start_time" type="text" readonly="readonly">
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer flex-center">
                                ...
                                <!--end::Button-->
                                <!--begin::Button-->
                                <button type="submit ddd" class="btn btn-primary">
...
<link href="<?= base_url() ?>components/css/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />

<script src="<?= base_url() ?>components/js/fullcalendar.bundle.js"></script>
<!--end::Vendor Stylesheets-->
<!-- <script src="<?= base_url() ?>components/js/scripts.bundle.js"></script>
<script src="<?= base_url() ?>components/js/custom/apps/calendar/calendar.js"></script> -->