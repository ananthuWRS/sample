                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    <th class="w-10px pe-2 no-sort sorting_disabled">
                                    ...
                                    <th class="min-w-50px no-sort sorting_disabled">Status</th>
                                    <th class="min-w-50px no-sort sorting_disabled">Time Spent</th>
                                    <th class="text-center min-w-100px no-sort sorting_disabled"
                                        style="text-align: center !important;">Actions</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
