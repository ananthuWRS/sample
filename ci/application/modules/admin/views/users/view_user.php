    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">View User
                    Details</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="<?=base_url()?>components/media/avatars/blank.png" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="#"
                                    class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3"><?=$userdata->au_title.' '.$userdata->au_crickf?></a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-9">
                                    <!--begin::Badge-->
                                    <div class="badge badge-lg badge-light-primary d-inline"><?=$userdata->ut_name?>
                                    </div>
                                    <!--begin::Badge-->
                                </div>
                                <!--end::Position-->
                                <!--begin::Info-->
                                <!--begin::Info heading-->
                                <div class="fw-bold mb-3">Assigned Task
                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                        data-bs-trigger="hover" data-bs-html="true"
                                        data-bs-content="Number of tasks assigned."></i>
                                </div>
                                <!--end::Info heading-->
                                <div class="d-flex flex-wrap flex-center">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                        <div class="fs-4 fw-bold text-gray-700">
                                            <span class="w-75px"><?=(isset($taskList))?count($taskList):'0'?></span>
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600"><?=$userdata->au_cricke?></div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Employee Number</div>
                                    <div class="text-gray-600">
                                        <a href="#"
                                            class="text-gray-600 text-hover-primary"><?=$userdata->au_emp_number?></a>
                                    </div>
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Reporting Person</div>
                                    <div class="text-gray-600">
                                        <?=($userdata->reportingpersonname) ? ucfirst(strtolower($userdata->reporttitle.' '.$userdata->reportingpersonname)).'('.$userdata->reportempnumber.')' : 'Not Assigned'?>
                                    </div>
                                    <!--begin::Details item-->

                                    <div class="fw-bold mt-5">Gender</div>
                                    <div class="text-gray-600"><?=$userdata->au_gender?></div>
                                    <!--begin::Details item-->

                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Designation</div>
                                    <div class="text-gray-600"><?=$userdata->au_designation?></div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Department</div>
                                    <div class="text-gray-600"><?=$userdata->au_deptarment?></div>
                                    <!--begin::Details item-->

                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">School</div>
                                    <div class="text-gray-600"><?=$userdata->au_school?></div>
                                    <!--begin::Details item-->

                                    <!--begin::Details item-->
                                    <div class="fw-bold mt-5">Campus</div>
                                    <div class="text-gray-600"><?=$userdata->au_campus?></div>
                                    <!--begin::Details item-->
                                </div>
                            </div>
                            <!--end::Details content-->
                    ...
                    <!--end::Table-->
                                    ...
                                    <div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
													<!--begin::Add Task-->
                                                   <?php // if($ratingcnt->ratingcnt <= 0){?>
													<button type="button" class="btn btn-primary addratingpopup" data-item="<?=$id;?>">
                                ...
                                <div class="card-body p-9 pt-4">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_usersrating">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-title flex-column">
                                        ...
                                        <div class="fs-6 fw-semibold text-muted">Total <?=(isset($taskList))?count($taskList):'0'?> tasks in backlog</div>
                                    </div>
                                    <!--end::Card title-->
                                    <!--begin::Card toolbar-->
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <button type="button" data-id="<?=$id?>" data-auth="<?=$auth?>" class="btn btn-primary btn-sm adminStaffProfileAddTask">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="#" class="fs-5 fw-bold text-dark text-hover-primary"><?=$task->task_title?></a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted"><?=date('d/m/Y',strtotime($task->task_date))?>
                                                <a href="#"><?=ucfirst(strtolower($task->task_priority))?></a>
                                            </div>
                                            <!--end::Info-->
                                        </div>
                                        <!--end::Details-->
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            ...
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                <div class="fs-5 text-dark fw-bold">Action </div>
                                            </div>
                                            <!--end::Header-->
                                            ...
                                            <form class="form px-7 py-5" data-kt-menu-id="kt-users-tasks-form">
												...
												<a href="<?=base_url()?>staff/viewtask/<?=$task->taskid?>/<?=$controller->checksumgen($task->taskid)?>"  class="btn btn-light-success mt-2  btn-sm " ><i class="fa fa-eye"></i>View</a>
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                ...
                                                <label class="form-check-label"
                                                    ...
                                                    <div class="text-gray-600">Receive a notification if a customer
                                                        sends an incorrect amount to pay their invoice.</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Checkbox-->
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2022, 8:43 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2022, 6:43 am
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2022, 6:43 am
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2022, 11:05
                                                    am</td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2022, 8:43 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2022, 6:05 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2022, 2:40 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <tr>
                                                ...
                                                <!--end::Event=-->
                                                <!--begin::Timestamp=-->
                                                <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2022, 6:05 pm
                                                </td>
                                                <!--end::Timestamp=-->
                                            </tr>
                                            <!--end::Table row-->
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <div class="image-input image-input-outline image-input-placeholder"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url(components/media/avatars/300-6.jpg">
                                                    </div>
