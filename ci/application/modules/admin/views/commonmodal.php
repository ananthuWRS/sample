            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_add_category_form" class="form" action="#" data-parsley-validate>
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                        <input type="hidden" name="editid" id="editid"
                            value="<?= (isset($editdata)) ? $editdata->designation_id : '' ?>">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" required name="designation_name" id="designation_name"
                                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Designation Name"
                                value="<?= (isset($editdata)) ? $editdata->designation_name : '' ?>" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
