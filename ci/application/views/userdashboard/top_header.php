					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="../../demo1/dist/index.html" class="d-lg-none">
								<img alt="Logo" src="<?= base_url() ?>components/media/logos/default-small.svg" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">
														<span class="capitalize"><?= $this->userlogged_data->au_crickf ?>
                                                <?= $this->userlogged_data->au_crickl ?></span>
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?=$this->session->userdata('usertypename')?></span></div>
